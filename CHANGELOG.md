## 3.1.8
  - Fix tests failure for  ELASTIC_STACK_VERSION=8.x. Fail message: undefined method `validating_keys?' for BSON::Config:Module [#89](https://github.com/logstash-plugins/logstash-output-mongodb/pull/89)
    - MongoDB connection error - Failed to handshake [#88](https://github.com/logstash-plugins/logstash-output-mongodb/issues/88)
