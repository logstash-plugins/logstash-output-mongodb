...
If true, replace the document on MongoDB if a document with the same _id already exists.
If the event does not have a _id field, will do a regular insert.
Incompatible with generateId.
